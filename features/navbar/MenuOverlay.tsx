...
const GhostIcon = () => (
  <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M20 0C8.954 0 0 8.954 0 20v20l6.667-6.667L13.333 40l6.667-6.667L26.667 40l6.667-6.667L40 40V20C40 8.954 31.046 0 20 0z" fill="#FF0000"/>
...
export function MenuOverlay({ isOpen, onClose }: MenuOverlayProps) {
  ...
  useGsapContext(
    () => {
      ...
      if (isOpen) {
        gsap.killTweensOf([overlayRef.current, links, footerElements, ...pageElements]);
    ...
    >
      ...
      >
        ...
        <div className="space-y-8 lg:space-y-16 lg:pl-8">
          {/* Sitemap */}
          <div>
            <h4 className="text-[10px] uppercase tracking-[0.2em] text-white/50 mb-3 lg:mb-8 font-semibold menu-footer-item">Sitemap</h4>
          ...
          {/* Follow */}
          <div>
            <h4 className="text-[10px] uppercase tracking-[0.2em] text-white/50 mb-3 lg:mb-6 font-semibold menu-footer-item">Follow</h4>
